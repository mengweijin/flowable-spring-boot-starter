 ...
 */
package com.github.mengweijin.flowable.rest.copy;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.node.ArrayNode;
import com.fasterxml.jackson.databind.node.ObjectNode;
import com.github.mengweijin.flowable.rest.copy.mapper.EventInfoMapper;
import com.github.mengweijin.flowable.rest.copy.mapper.InfoMapper;
import com.github.mengweijin.flowable.rest.copy.mapper.ReceiveTaskInfoMapper;
import com.github.mengweijin.flowable.rest.copy.mapper.SequenceFlowInfoMapper;
import com.github.mengweijin.flowable.rest.copy.mapper.ServiceTaskInfoMapper;
import com.github.mengweijin.flowable.rest.copy.mapper.UserTaskInfoMapper;
...
public class BpmnDisplayJsonConverter {
    ...
    public void processProcessElements(Model model, ObjectNode displayNode, GraphicInfo diagramInfo) {
        ...
        if (!StringUtils.isEmpty(model.getMetaInfo())) {
            try {
                ...
                LOGGER.error("Error transforming json to pojo {}", model.getId(), e);
            }
        }
